...
zythum_sort('collecting',    10, 01, 'storage-tank')  
...
zythum_sort('logistics',      06, 01, 'copper-cable')
...
zythum_sort('intermediate',  05, 01, 'battery')
zythum_sort('intermediate',  05, 02, 'engine-unit')
zythum_sort('intermediate',  05, 03, 'electric-engine-unit')
zythum_sort('intermediate',  05, 04, 'flying-robot-frame')
zythum_sort('intermediate',  10, 01, 'rocket-silo')
zythum_sort('intermediate',  10, 02, 'low-density-structure')
zythum_sort('intermediate',  10, 03, 'rocket-fuel')
zythum_sort('intermediate',  10, 04, 'rocket-part')
zythum_sort('intermediate',  10, 05, 'rocket-control-unit')
zythum_sort('intermediate',  10, 06, 'satellite')
...
zythum_sort('resources',     02, 01, 'coal')
zythum_sort('resources',     02, 02, 'stone')
zythum_sort('resources',     02, 03, 'iron-ore')
zythum_sort('resources',     02, 04, 'copper-ore')
